 ...
 */
final class Version20210419124806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD user_id INT NOT NULL, ADD categorie_id INT NOT NULL, DROP user_id_id, DROP categorie_id_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD user_id_id INT NOT NULL, ADD categorie_id_id INT NOT NULL, DROP user_id, DROP categorie_id');
